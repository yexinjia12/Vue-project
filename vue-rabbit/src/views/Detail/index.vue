...
const getGoods = async () => {
  ...
  // // 响应对象接收一下goods.categories的值，处理数据嵌套层级太深的问题
    ...
    <div class="container">
      ...
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- 或者使用一个响应对象接收一下goods.categories的值，但还是感觉会出现闪一下的情况 -->
          <!-- <el-breadcrumb-item :to="{ path: `/category/${subCategories.id}` }">{{ subCategories.name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/sub/${threeCategories.id}` }">{{ threeCategories.name }}
          </el-breadcrumb-item> -->
